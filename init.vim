...
"" Basic config Ref: https://github.com/mathiasbynens/dotfiles/blob/master/.vimrc
...
"set esckeys " option not available in neovim
...
set binary
set noeol
" Turn off backup. Some servers have issues with backup files
"set nobackup
"set noswapfile
"set nowritebackup
...
set noshowmode " set because mode already displayed in modeline
